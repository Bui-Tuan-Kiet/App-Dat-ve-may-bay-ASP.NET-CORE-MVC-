...
namespace QLBANVEMAYBAY
{
    public class Connection
    {
        ...
        SqlConnection cn = new SqlConnection(@"Data Source=KENWAY\SQLEXPRESS;Initial Catalog=Vemaybay;Integrated Security=True");
        string chuoiketnoi = @"Data Source=KENWAY\SQLEXPRESS;Initial Catalog=Vemaybay;Integrated Security=True";
        public Connection()
        {
